...
import { deleteGeneros, postGeneros, putGeneros } from "../../services/GenerosService";
import toast from "react-hot-toast";


const GeneroForm = ({ toggleForm, genero = null }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (genero._id) {
        ...
        await postGeneros({ nombre, descripcion, imagen: imagenUrl, estado });
    ...
    <div className="flex w-full h-full justify-center items-center">
      <div className="bg-[#202020] w-[30rem] p-4 rounded-lg">
        <h2 className="text-white text-xl mb-4">
          {genero._id ? "Actualizar Género" : "Crear Nuevo Género"}
        </h2>
